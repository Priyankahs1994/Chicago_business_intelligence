...
func main() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=/cloudsql/cbi-phase-three:us-central1:mypostgres sslmode=disable port = 5432"
...
func GetTaxiTrips(db *sql.DB) {
	...
	var url = "https://data.cityofchicago.org/resource/wrvz-psew.json?$limit=200"
